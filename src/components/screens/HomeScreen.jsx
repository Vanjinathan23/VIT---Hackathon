        ...
        return (
            <article className="issue-post" onClick={handlePostClick} style={{ cursor: 'pointer', margin: isMobile ? '0 0 32px 0' : '0' }}>
                ...
                <div className="post-header">
                    <div className="post-user-info" onClick={(e) => { e.stopPropagation(); navigate('profile'); }}>
                        <div className="profile-circle">
                            {issue.profileImage ? (
                                <img src={issue.profileImage} alt={issue.username} style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover' }} />
                            ) : (
                                <span className="material-symbols-outlined" style={{ fontSize: 20, color: '#1e3a8a' }}>account_balance</span>
                            )}
                        </div>
                        <div className="post-user-meta">
                            <span className="post-username">{issue.username}</span>
                ...
                <div className="post-caption">
                    <span className="caption-username">{issue.username}</span>
        ...
        <div className="home-right-sidebar animate-fade-in" style={{ padding: '0 0 0 0' }}>
            <div className="user-profile-summary" onClick={() => navigate('profile')} style={{ cursor: 'pointer' }}>
                ...
                <div className="user-text-info">
                    ...
                    <span className="user-fullname">{user.username === 'civic_user_01' ? 'First Civic User' : 'Chennai Citizen'}</span>
                </div>
            ...
            <div className="suggestions-list">
                {[
                    { id: 1, name: 'sarah_civic', img: 'https://i.pravatar.cc/150?u=sarah' },
                    { id: 2, name: 'mike_chennai', img: 'https://i.pravatar.cc/150?u=mike' },
                    { id: 3, name: 'green_activist', img: 'https://i.pravatar.cc/150?u=green' },
                    { id: 4, name: 'tn_commuter', img: 'https://i.pravatar.cc/150?u=tn' },
                    { id: 5, name: 'urban_planner', img: 'https://i.pravatar.cc/150?u=planner' }
                ].map(item => (
                    <div key={item.id} className="suggestion-item">
                        ...
                        <div className="suggestion-text">
                            <span className="suggestion-username">{item.name}</span>
                            <span className="suggestion-subtext">Followed by citizen_A</span>
                        </div>
